...
- Currently hidden from the nav bar (Verifier is the default tab) — re-enable it in `index.html` to use it.
...
3. Go to the **Generator** tab (re-enable it in `index.html` first — see Features above).
